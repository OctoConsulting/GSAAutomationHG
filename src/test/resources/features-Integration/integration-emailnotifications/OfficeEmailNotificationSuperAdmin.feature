Feature: Automate Email Notification SuperAdmin 

Scenario: As a content FH Admin, create an office and validate appropriate email. When an office is submitted, user validates that profile page displays "No office types available". Troy gets a email with xml attachment, super admin gets email without attachment. 
